...
ITEMS = {
    ...
    ItemID.SMOKE_BOMB: Item(
        'Smoke Bomb', 'Escape combat for free',
        consumable=True, ability_id=AbilityID.ESCAPE_FROM_BATTLE,
    ),
    ItemID.STAMINA_POTION: Item(
        'Stamina Potion', 'Restore 30 Stamina',
        consumable=True, uses=3, curr_st=30,
    ),
    ItemID.MP_POTION: Item(
        'MP Potion', 'Recover 15 MP',
        consumable=True, uses=3, curr_mp=15,
    ),
    ItemID.AT_POTION: Item(
        'AT Potion', 'Gain 3 Temporary AT',
        consumable=True, uses=2, temp_at=3,
    ),
    ItemID.EP_POTION: Item(
        'EP Potion', 'Gain 2 Temporary EP',
        consumable=True, uses=2, temp_ep=2,
    ),
    ItemID.PICKAXE: Item(
        'Pickaxe', 'Gives a +20 Modifier to rolls in the mines',
        consumable=True, uses=10,
        ability_id=AbilityID.MINES_MODIFIER, ability_mod=20,
    ),
    ItemID.SMALL_FEATHER_BOMB: Item(
        'Small Feather Bomb', 'Deals 25 damage to a mob or player',
        consumable=True, curr_st=-25,
    ),
    ItemID.TICKLE_TRAP: Item(
        'Tickle Trap',
        'Place it somewhere to force an unsuspecting player '
        'suffer a debuff and take damage',
        consumable=True, trap=True,
        trap_id=TrapID.TICKLE_TRAP,
        trap_mod=-10, trap_dmg=5,
    ),
    ItemID.TOLLBOOTH: Item(
        ...
        consumable=True, trap=True,
        trap_id=TrapID.TOLLBOOTH, trap_fee=25,
    ),
    ItemID.FEATHER_SWORD: Item(
        'Feather Sword',
        'Increases your damage dice to 1d10',
        weapon=True, dmg_dice=(1, 10), dur=10,
    ),
    ...
    ItemID.BOW: Item(
        ...
        weapon=True, once_a_combat=True, ignore_hit_roll=True,
        require_ammo=True, ammo_item_id=ItemID.FEATHERARROW,
        ammo_count=3, dmg_dice=(1, 20),
    ),
    ItemID.FEATHERARROW_QUIVER: Item(
        'Feather Arrow Quiver', 'A pack of 10 Feather Arrows',
        ammo_pack=True, ammo_item_id=ItemID.FEATHERARROW,
        ammo_count=3,
    ),
    ItemID.GREATER_FEATHER_BOMB: Item(
        'Greater Feather Bomb', 'Deals 50 damage to a mob or player',
        consumable=True, curr_st=-50,
    ),
    ItemID.POTION_VERSATILITY: Item(
        ...
        consumable=True, curr_st=25, temp_at=1, temp_ep=1,
    ...
    ItemID.POTION_CONSTITUTION: Item(
        'Potion of Constitution', 'Increases Max ST by 15',
        consumable=True, max_st=15,
    ),
    ItemID.POTION_FOCUS: Item(
        'Potion of Focus', 'Increases Max MP by 15',
        consumable=True, max_mp=15,
    ),
    ItemID.BOOK_TICKLISH_CURSES: Item(
        ...
        consumable=True, once_a_turn=True,
        uses=5, ability_id=AbilityID.CHOOSE_ONE,
        ability_choices=[
            Choice(
                'An action and 5 ST', curr_actions=-1, curr_st=-5,
            ),
            Choice(
                '20G and 10 ST', curr_gold=-20, curr_st=-10,
            ),
            Choice(
                'All stats -1 temporarily and 5 ST', temp_all=-1, curr_st=-5,
            ),
            Choice(
                'All EP and 10 ST', set_ep=0, curr_st=-10,
            ),
        ],
    ),
    ItemID.FEATHER: Item(
        'Feather', 'Tickle an opponent making them lose 1 action and 10 ST',
        consumable=True, once_a_turn=True,
        uses=3, curr_actions=-1, curr_st=-10,
    ),
    ...
    ItemID.FEATHERARROW: Item(
        'Feather Arrow', 'Ammunition for the bow', ammo=True,
    ),

    # Trinkets
    ItemID.GRINDSTONE: Item(
        'Grindstone', '', trinket=True
    ),
    ItemID.RING_ENDURANCE: Item(
        'Ring of Endurance', '', trinket=True
    ),
    ItemID.GOLDEN_FEATHER: Item(
        'Golden Feather', '', trinket=True
    ),
    ItemID.BROKEN_FEATHERARROW: Item(
        'Broken Featherarrow', '', trinket=True
    ),
    ItemID.LIQUID_LAUGHTER_VIAL: Item(
        'Liquid Laughter Vial', '', trinket=True
    ),
    ItemID.SWIFT_FEATHER: Item(
        'Swift Feather', '', trinket=True
    ),
}
